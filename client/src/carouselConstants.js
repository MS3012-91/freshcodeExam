...
const imagePath = CONSTANTS.STATIC_IMAGES_PATH;
const mainSlider = CONSTANTS.MAIN_SLIDER;
...
export default {
  ...
  mainSliderImages: [
    `${imagePath}${mainSlider}/21..jpg`,
    `${imagePath}${mainSlider}/B_1_01.jpg`,
    `${imagePath}${mainSlider}/B_2_15.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_AA_48_StyleRevolver.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_AD_32_Monvelli.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_AG_15_Trusthaven.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_AK_03_pawxie.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_L_09_lush.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_P_42_Avanti.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_S_25_Autovity.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_W_33_Quantic.jpg`,
    `${imagePath}${mainSlider}/Banner_Visual_Name_Y_29_Vechetti.jpg`,
  ],
  exampleSliderImages: [
    `${imagePath}${exampleSlider}/1.jpg`,
    `${imagePath}${exampleSlider}/2.jpg`,
    `${imagePath}${exampleSlider}/3.jpg`,
    `${imagePath}${exampleSlider}/4.jpg`,
    `${imagePath}${exampleSlider}/5.jpg`,
    `${imagePath}${exampleSlider}/6.jpg`,
    `${imagePath}${exampleSlider}/7.jpg`,
    `${imagePath}${exampleSlider}/8.jpg`,
    `${imagePath}${exampleSlider}/9.jpg`,
    `${imagePath}${exampleSlider}/10.jpg`,
    `${imagePath}${exampleSlider}/11.jpg`,
    `${imagePath}${exampleSlider}/12.jpg`,
  ],
  feedbackSliderImages: [
    `${imagePath}${feedbackSlider}/Blue dress professional Lynne Lowder-avatar.jpg`,
    `${imagePath}${feedbackSlider}/Bonnie Linked-avatar.jpg`,
    `${imagePath}${feedbackSlider}/IMG_0232-avatar.jpg`,
    `${imagePath}${feedbackSlider}/me (5)-avatar.jpeg`,
    `${imagePath}${feedbackSlider}/MoonFamily web size-avatar.jpg`,
    `${imagePath}${feedbackSlider}/nathan2-avatar.jpg`,
    `${imagePath}${feedbackSlider}/Simon-avatar.jpg`,
    `${imagePath}${feedbackSlider}/squad-avatar.jpg`,
    `${imagePath}${feedbackSlider}/Unbenannt1-avatar.jpg`,
  ],
  EXAMPLE_SLIDER_TEXT: [
    'vib.io',
    'Exactly.com',
