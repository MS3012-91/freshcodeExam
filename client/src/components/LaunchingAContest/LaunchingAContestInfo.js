    ...
    faqs: [
      ...
      },
      {
        ...
        variants: [
          ...
          {
            id: 2,
            variant: 'Tagline Examples',
          },
          {
            id: 3,
            variant: 'Logo Examples',
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        variants: [
          ...
          },
          {
            id: 3,
            variant:
              'Here is a link to our Pricing page Window with a detailed comparison of the two packages.',
          },
          {
            id: 4,
            variant:
...
export const linkMapping = [
    { anchor: 'Pricing Page', url: 'pricing.php?bundle-id=4' },
    { anchor: 'Refund Policy', url: 'articles/115621-refund-policy' },
    { anchor: 'Name Examples', url: '/Name-Ideas' },
    {
      anchor: 'Tagline Examples',
      url: '/tagline-slogan-ideas',
    },
    {
      anchor: 'Logo Examples',
      url: '/logo-design-examples',
    },
    {
      anchor: 'Managed Contest Service',
      url: '/managed-contests',
    },
    {
      anchor: 'Pricing page',
      url: '/create/managed_contests',
    },
    {
      anchor: 'Quality Scoring',
      url: '/articles/91702-percentile-ranking-score',
    },
  ];
